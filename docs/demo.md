...
The public demo must distinguish implemented interfaces from planned ones. The GitHub Action, stateless REST API, and minimal web UI are available as separate interfaces; Docker Compose and optional AI provider analysis remain planned roadmap items.
