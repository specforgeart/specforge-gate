...
`specforge_gate.__version__` are both `0.3.2`.
...
git tag -a v0.3.2 <verified-main-sha> -m "SpecForge Gate v0.3.2"
...
```text
specforge_gate-0.3.2-py3-none-any.whl
specforge_gate-0.3.2.tar.gz
SHA256SUMS
```
